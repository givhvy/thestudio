...
StratumGuitarAudioProcessorEditor::StratumGuitarAudioProcessorEditor(StratumGuitarAudioProcessor& processor)
    : AudioProcessorEditor(&processor), processor_(processor)
{
    title_.setText("Stratum Guitar", juce::dontSendNotification);
...
void StratumGuitarAudioProcessorEditor::paint(juce::Graphics& g)
{
...
void StratumGuitarAudioProcessorEditor::resized()
{
