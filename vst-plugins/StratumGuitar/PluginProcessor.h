...
class StratumGuitarAudioProcessor final : public juce::AudioProcessor
{
public:
    StratumGuitarAudioProcessor();
    ~StratumGuitarAudioProcessor() override = default;
    ...
    const juce::String getName() const override { return "Stratum Guitar"; }
...
private:
    ...
    std::vector<GuitarSample> samples_;
    juce::AudioFormatManager formatManager_;
    juce::File sampleFolder_;
    double sampleRate_ = 44100.0;
    int loadedSampleCount_ = 0;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(StratumGuitarAudioProcessor)
};
